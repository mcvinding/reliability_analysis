...
[alpha_int, boot_int] = reliability_analysis(dat, 'interval', 10000);  % Assuming interval data
[alpha_ord, boot_ord] = reliability_analysis(dat, 'ordinal', 10000);   % Assuming ordinal data
[alpha_nom, boot_nom] = reliability_analysis(dat, 'nominal', 10000);   % Assuming nominal data
